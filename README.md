...
#API Keys
Keys for the APIs are stored in the .env file and are called on and stored as variables in the keys.js file. 

#Twitter API
Twitter API changed which caused this API call not to work. It was changed out for the Google Books API. 

#Commands 
Commands that can be run in the console for this application are: 
    1. Book Search: node liri.js book-this ``name_of_book`` 
    2. Song Search: node liri.js spotify-this ``name_of_song`` 
    3. Movie Search: node liri.js movie-this ``name_of_movie`` 

#NPM Packages
Make sure to install the following packages before running the program: 
    - .env file (you will have to upload your own API keys)
    - npm install request 
    - npm install dotenv 
    - npm install node-spotify-api

Notes for the homework overall can be found below: 
